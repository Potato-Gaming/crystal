...
pub struct LolPftPftEndOfGameStats {
    ...
    #[serde(rename = "isAramGame", skip_serializing_if = "Option::is_none")]
    pub is_aram_game: Option<bool>,
    ...
    pub points_penalties: Option<serde_json::Value>,
    ...
    pub reroll_data: Option<crate::models::LolPftPftEndOfGamePoints>,
    ...
    pub teams: Option<Vec<crate::models::LolPftPftEndOfGameTeam>>,
...
impl LolPftPftEndOfGameStats {
    pub fn new() -> LolPftPftEndOfGameStats {
