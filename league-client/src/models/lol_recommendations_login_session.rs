...
pub struct LolRecommendationsLoginSession {
    ...
    pub state: Option<crate::models::LolRecommendationsLoginSessionStates>,
    #[serde(rename = "summonerId", skip_serializing_if = "Option::is_none")]
    pub summoner_id: Option<i64>,
}

impl LolRecommendationsLoginSession {
    pub fn new() -> LolRecommendationsLoginSession {
