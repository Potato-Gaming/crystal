...
pub struct LolCosmeticsCosmeticsTftDamageSkinViewModel {
    ...
    pub upgrades: Option<Vec<crate::models::LolCosmeticsCosmeticsTftDamageSkinViewModel>>,
}

impl LolCosmeticsCosmeticsTftDamageSkinViewModel {
    pub fn new() -> LolCosmeticsCosmeticsTftDamageSkinViewModel {
