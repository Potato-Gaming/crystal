...
pub struct LolLobbyTeamBuilderChampSelectSession {
    ...
    pub chat_details: Option<crate::models::LolLobbyTeamBuilderChampSelectChatRoomDetails>,
    ...
    pub entitled_feature_state: Option<crate::models::LolLobbyTeamBuilderEntitledFeatureState>,
    ...
    pub my_team: Option<Vec<crate::models::LolLobbyTeamBuilderChampSelectPlayerSelection>>,
    ...
    pub their_team: Option<Vec<crate::models::LolLobbyTeamBuilderChampSelectPlayerSelection>>,
    #[serde(rename = "timer", skip_serializing_if = "Option::is_none")]
    pub timer: Option<crate::models::LolLobbyTeamBuilderChampSelectTimer>,
    #[serde(rename = "trades", skip_serializing_if = "Option::is_none")]
    pub trades: Option<Vec<crate::models::LolLobbyTeamBuilderChampSelectTradeContract>>,
}

impl LolLobbyTeamBuilderChampSelectSession {
    pub fn new() -> LolLobbyTeamBuilderChampSelectSession {
