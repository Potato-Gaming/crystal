...
pub struct RecofrienderLoginSession {
    ...
    pub state: Option<crate::models::RecofrienderLoginSessionStates>,
    #[serde(rename = "summonerId", skip_serializing_if = "Option::is_none")]
    pub summoner_id: Option<i64>,
}

impl RecofrienderLoginSession {
    pub fn new() -> RecofrienderLoginSession {
