...
pub struct LolClashScoutingChampions {
    ...
    pub top_masteries: Option<Vec<crate::models::LolClashScoutingChampionMastery>>,
    #[serde(rename = "topSeasonChampions", skip_serializing_if = "Option::is_none")]
    pub top_season_champions: Option<Vec<crate::models::LolClashScoutingSeasonChampion>>,
    #[serde(rename = "totalMasteryScore", skip_serializing_if = "Option::is_none")]
    pub total_mastery_score: Option<i64>,
}

impl LolClashScoutingChampions {
    pub fn new() -> LolClashScoutingChampions {
