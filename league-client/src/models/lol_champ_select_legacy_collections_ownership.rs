...
pub struct LolChampSelectLegacyCollectionsOwnership {
    ...
    pub rental: Option<crate::models::LolChampSelectLegacyCollectionsRental>,
}

impl LolChampSelectLegacyCollectionsOwnership {
    pub fn new() -> LolChampSelectLegacyCollectionsOwnership {
