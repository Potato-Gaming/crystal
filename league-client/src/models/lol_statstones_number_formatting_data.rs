...
pub struct LolStatstonesNumberFormattingData {
    ...
    pub number_formatting_behavior: Option<crate::models::LolStatstonesNumberFormattingBehavior>,
...
impl LolStatstonesNumberFormattingData {
    pub fn new() -> LolStatstonesNumberFormattingData {
