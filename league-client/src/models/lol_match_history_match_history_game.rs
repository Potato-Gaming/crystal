...
pub struct LolMatchHistoryMatchHistoryGame {
    ...
    pub participant_identities: Option<Vec<crate::models::LolMatchHistoryMatchHistoryParticipantIdentities>>,
    #[serde(rename = "participants", skip_serializing_if = "Option::is_none")]
    pub participants: Option<Vec<crate::models::LolMatchHistoryMatchHistoryParticipant>>,
    ...
    pub teams: Option<Vec<crate::models::LolMatchHistoryMatchHistoryTeam>>,
}

impl LolMatchHistoryMatchHistoryGame {
    pub fn new() -> LolMatchHistoryMatchHistoryGame {
