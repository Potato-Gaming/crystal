...
pub struct LolMatchHistoryMatchHistoryParticipant {
    ...
    pub stats: Option<crate::models::LolMatchHistoryMatchHistoryParticipantStatistics>,
    #[serde(rename = "teamId", skip_serializing_if = "Option::is_none")]
    pub team_id: Option<i32>,
    #[serde(rename = "timeline", skip_serializing_if = "Option::is_none")]
    pub timeline: Option<crate::models::LolMatchHistoryMatchHistoryTimeline>,
}

impl LolMatchHistoryMatchHistoryParticipant {
    pub fn new() -> LolMatchHistoryMatchHistoryParticipant {
