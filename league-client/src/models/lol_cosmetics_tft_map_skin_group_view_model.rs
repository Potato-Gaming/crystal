...
pub struct LolCosmeticsTftMapSkinGroupViewModel {
    ...
    pub items: Option<Vec<crate::models::LolCosmeticsCosmeticsTftMapSkinViewModel>>,
...
impl LolCosmeticsTftMapSkinGroupViewModel {
    pub fn new() -> LolCosmeticsTftMapSkinGroupViewModel {
