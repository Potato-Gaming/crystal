...
pub struct LolLobbyTeamBuilderQueue {
    ...
    pub category: Option<crate::models::LolLobbyTeamBuilderQueueGameCategory>,
    ...
    pub game_type_config: Option<crate::models::LolLobbyTeamBuilderQueueGameTypeConfig>,
    ...
    pub queue_availability: Option<crate::models::LolLobbyTeamBuilderQueueAvailability>,
    #[serde(rename = "queueRewards", skip_serializing_if = "Option::is_none")]
    pub queue_rewards: Option<crate::models::LolLobbyTeamBuilderQueueReward>,
...
impl LolLobbyTeamBuilderQueue {
    pub fn new() -> LolLobbyTeamBuilderQueue {
