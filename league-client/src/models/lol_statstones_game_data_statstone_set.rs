...
pub struct LolStatstonesGameDataStatstoneSet {
    ...
    pub statstones: Option<Vec<crate::models::LolStatstonesGameDataStatstone>>,
}

impl LolStatstonesGameDataStatstoneSet {
    pub fn new() -> LolStatstonesGameDataStatstoneSet {
