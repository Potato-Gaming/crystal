...
pub struct LolGameflowQueue {
    ...
    pub category: Option<crate::models::LolGameflowQueueGameCategory>,
    ...
    pub game_type_config: Option<crate::models::LolGameflowQueueGameTypeConfig>,
    ...
    pub queue_availability: Option<crate::models::LolGameflowQueueAvailability>,
    #[serde(rename = "queueRewards", skip_serializing_if = "Option::is_none")]
    pub queue_rewards: Option<crate::models::LolGameflowQueueReward>,
...
impl LolGameflowQueue {
    pub fn new() -> LolGameflowQueue {
        LolGameflowQueue {
