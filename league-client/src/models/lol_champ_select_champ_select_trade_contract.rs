...
pub struct LolChampSelectChampSelectTradeContract {
    ...
    pub state: Option<crate::models::LolChampSelectChampSelectTradeState>,
}

impl LolChampSelectChampSelectTradeContract {
    pub fn new() -> LolChampSelectChampSelectTradeContract {
