...
pub struct LolMatchmakingLobbyStatus {
    ...
    pub custom_spectator_policy: Option<crate::models::LolMatchmakingQueueCustomGameSpectatorPolicy>,
...
impl LolMatchmakingLobbyStatus {
    pub fn new() -> LolMatchmakingLobbyStatus {
