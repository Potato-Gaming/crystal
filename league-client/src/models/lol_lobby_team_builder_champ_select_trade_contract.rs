...
pub struct LolLobbyTeamBuilderChampSelectTradeContract {
    ...
    pub state: Option<crate::models::LolLobbyTeamBuilderChampSelectTradeState>,
}

impl LolLobbyTeamBuilderChampSelectTradeContract {
    pub fn new() -> LolLobbyTeamBuilderChampSelectTradeContract {
