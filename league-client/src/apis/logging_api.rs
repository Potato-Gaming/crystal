...
pub struct LoggingApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> LoggingApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> LoggingApiClient<C> {
        LoggingApiClient {
            configuration,
        }
    }
...
impl<C: hyper::client::Connect>LoggingApi for LoggingApiClient<C> {
    fn post_riotclient_addorupdatemetric(&self, group: &str, object: &str, name: &str, value: i64) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
